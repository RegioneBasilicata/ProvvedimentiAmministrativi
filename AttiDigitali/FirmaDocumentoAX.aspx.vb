...
#Region " Codice generato da Progettazione Web Form "
    ...
    Private Sub Page_Init(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Init
        ...
        If statoIstanza.LivelloUfficio = "UP" Or ((statoIstanza.Ruolo = "R") And statoIstanza.LivelloUfficio <> "UR") Or ((statoIstanza.Ruolo = "R") And statoIstanza.LivelloUfficio <> "USS") Then
            messaggi_di_Warning.Add(Warning(idDocumento))
        End If
...
#End Region
    ...
    Private Sub btnFirma_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFirma.Click
        ...
        Else
            ...
            Response.Redirect("AllegatiDocumentoAction.aspx?key=" & Trim(context.Request.QueryString.Get("key")))
