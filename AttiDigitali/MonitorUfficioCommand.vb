Public Class MonitorUfficioCommand
    ...
    Protected Overrides Sub OnExecute(ByVal context As HttpContext)
        ...
        '    Case 0
        '        vettoredati = Elenco_Monitor(0, Format(txtDataInizio, "dd/MM/yyyy"), Format(txtDataFine, "dd/MM/yyyy"), txtOggettoRicerca, txtCodUfficio, txtDescUfficio, txtCodDipartimento, txtNumero, ufCons.ToArray, tipoRigetto)
        '        context.Items.Add("tipoApplic", 0)
        '    Case 1
        '        vettoredati = Elenco_Monitor(1, Format(txtDataInizio, "dd/MM/yyyy"), Format(txtDataFine, "dd/MM/yyyy"), txtOggettoRicerca, txtCodUfficio, txtDescUfficio, txtCodDipartimento, txtNumero, ufCons.ToArray, tipoRigetto)
        '        context.Items.Add("tipoApplic", 1)
        '    Case 2
        '        vettoredati = Elenco_Monitor(2, Format(txtDataInizio, "dd/MM/yyyy"), Format(txtDataFine, "dd/MM/yyyy"), txtOggettoRicerca, txtCodUfficio, txtDescUfficio, txtCodDipartimento, txtNumero, ufCons.ToArray, tipoRigetto)
        '        context.Items.Add("tipoApplic", 2)
        'End Select
        'context.Items.Add("vettoreDati", vettoredati)
        Monitors(context, "UFFICI")
    End Sub
