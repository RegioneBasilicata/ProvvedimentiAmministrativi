<%@ Page Language="vb" AutoEventWireup="false" Codebehind="GUAssegnazioni.aspx.vb" Inherits="AttiDigitali.GUAssegnazioni"%>
...
<html>
	...
	<body ms_positioning="FlowLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:Button cssclass="btn" id="btnAssegna" runat="server" Text="Assegna" ></asp:Button>
			<asp:Panel id="pnlNote" runat="server">
				<P>Messaggio per il destinatario del&nbsp;documento</P>
				<P>
