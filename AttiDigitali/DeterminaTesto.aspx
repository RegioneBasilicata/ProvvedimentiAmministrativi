<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DeterminaTesto.aspx.vb" Inherits="AttiDigitali.DeterminaTesto" ValidateRequest="False"%>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="pnlAggiungiAllegato" runat="server" Height="24px" HorizontalAlign="Center" Width="560px">
				...
				<P>&nbsp;</P>
				<P>&nbsp;</P>
				<P><STRONG>Allega testo&nbsp;determina</STRONG>:</P>
