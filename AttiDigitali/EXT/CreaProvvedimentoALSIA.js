        ...
        items: [{
            ...
            items: [{
                ...
                items: [{ id: "chkSalva",
                    ...
                    , { title: 'Altre informazioni', autoHeight: true, defaults: { autoHeight: true }, layout: 'form', id: 'tab_attributi' ,items : [{id: "AttributiRegistrati",xtype: "hidden"}]}
                ...
                Ext.getCmp('tab_ufficio').on('activate', function() {
                  ...
                  Ext.getCmp('tab_attributi').on('activate', function() {
                        if ( (Ext.getCmp('GridAttributi')) ==undefined){
                            var grid = buildGridAttributi();
                            Ext.getCmp('tab_attributi').add(grid);
                        }
