<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GestioneODG.aspx.vb" Inherits="AttiDigitali.GestioneODG" %>
...
<head runat="server">
   ...
   <script src="ext/CRUDAnagraficaBeneficiari.js" type="text/javascript"></script>
   
   <script src="ext/GestioneODG.js" type="text/javascript"></script>
   <script src="ext/OnReadyGestioneODG.js" type="text/javascript"></script>   
</head>
<body>
