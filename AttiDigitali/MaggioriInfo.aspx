<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MaggioriInfo.aspx.vb" Inherits="AttiDigitali.MaggioriInfo" %>
...
<head id="Head1" runat="server">
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <meta name="GENERATOR" content="Microsoft Visual Studio .NET 7.1" />
        ...
        <script src="ext/Messaggi.js" type="text/javascript"></script>
         <script src="ext/Suggerimenti.js" type="text/javascript"></script>
        <script src="ext/OnReadyMaggioriInfo.js" type="text/javascript"></script>
				...
				<tr>
					<td class="pagina" width="25%">
			   		...
			   		<td class="pagina" width="75%">
					    ...
					    <div id="ListaMessaggi"></div>
					    <div id="Osservazioni"></div>  
					    <div id="ListaSuggerimenti"></div> 
			        </td>
				</tr>
