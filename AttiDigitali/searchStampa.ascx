<%@ Control Language="vb" AutoEventWireup="false" Codebehind="searchStampa.ascx.vb" Inherits="AttiDigitali.searchStampa" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<p><asp:Label ID="lblTipo" runat="server" Text="Filtra se: "></asp:Label> <asp:DropDownList id="dllStatoStampa" runat="server" ><asp:ListItem Value="0" >Da Stampare</asp:ListItem><asp:ListItem Value="1">Stampata</asp:ListItem></asp:DropDownList></p>			
		<p>
