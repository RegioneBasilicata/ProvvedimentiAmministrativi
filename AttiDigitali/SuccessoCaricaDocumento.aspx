<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SuccessoCaricaDocumento.aspx.vb" Inherits="AttiDigitali.SuccessoCaricaDocumento" ValidateRequest="False"%>
...
<html>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<P>
				<asp:Button id="btnOk" runat="server" Text="OK" Visible="False" cssclass="btn"></asp:Button>
			</P>
		</form>
	</body>
</html>
