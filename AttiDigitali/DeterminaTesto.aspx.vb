...
#End Region
        ...
        Try
            If Not IsPostBack Then
                ...
                Else
                    ...
                    Label2.Text = "Impossibile editare il testo della determina."
                End If
    ...
    Private Sub btnSalvaTesto_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvaTesto.Click
        ...
        If fileUploadAllegato.PostedFile.ContentLength <> 0 Then
            ...
            If UCase(fileUploadAllegato.PostedFile.ContentType) = "RTF" And estensione(estensione.Length - 1).Equals("rtf") Then
                ...
                Session.Add("testoDetermina", bFile)
