...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DocumentoTesto.aspx.vb" Inherits="AttiDigitali.DocumentoTesto" ValidateRequest="False"%>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="pnlAggiungiAllegato" runat="server" Height="24px" HorizontalAlign="Center" Width="560px">
				...
				<P>&nbsp;</P>
				<P>&nbsp;</P>
				<P><STRONG>Allega testo&nbsp;documento</STRONG>:</P>
				<P>seleziona il file RTF&nbsp; <INPUT id="fileUpLoadAllegato" type="file" accept="application/msword" name="fileUpLoadAllegato"
						runat="server"></P>
				<P align="center"></P>
			</asp:panel>
			<P>&nbsp;</P>
