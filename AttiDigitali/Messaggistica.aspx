<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Messaggistica.aspx.vb" Inherits="AttiDigitali.Messaggistica" %>
...
<head id="Head1" runat="server">
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <meta name="GENERATOR" content="Microsoft Visual Studio .NET 7.1" />
        ...
        <script src="ext/onReadyMessaggi.js" type="text/javascript"></script>
...
<body>
			...
			<form id="Form1" runat="server">
			 <asp:HiddenField ID="inviati" runat="server" />
			</form>
	</body>
</html>
