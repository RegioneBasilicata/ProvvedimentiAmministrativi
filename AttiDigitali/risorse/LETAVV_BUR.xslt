	...
	font-size:14px;
			...
			<body>
				<table Border="0" width="100%" cellpadding="3" cellspacing="0">
					...
					<tr>
						<td>
							<xsl:value-of select="/dat<?xml version="1.0" encoding="UTF-8" ?>
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
			<head>
	...
	font-size:14px;
			...
			<body>
				<table Border="0" width="100%" cellpadding="3" cellspacing="0">
					...
					<tr>
						<td align="center">Al Dirigente Responsabile Bollettino Ufficiale</td>
					</tr>
					<tr>
...
</xsl:stylesheet>ilettera/ufficio" />
						</td>
					</tr>
					<tr>
						<td align="left">Prot. n° </td>
