<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AssegnaNumerazione.aspx.vb" Inherits="AttiDigitali.AssegnaNumerazione"%>
...
<html>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:TextBox id="txtNumDef2" runat="server" Visible="False"></asp:TextBox>
			<br/>
			<br/>
			<asp:Button id="btnRegistra" runat="server" Text="Registra" Width="80px" Visible="False"></asp:Button></form>
	</body>
</html>
