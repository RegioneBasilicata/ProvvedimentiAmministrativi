<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FirmaDocumenti.aspx.vb" Inherits="AttiDigitali.FirmaDocumenti"%>
...
<html>
	<head>
		...
		<script language="JavaScript" src="FirmaDocumenti2.js"></script>
		...
		<form id="Form1" onsubmit="firmaDocumento()" method="post" runat="server">
			...
			<P><asp:panel id="pnlFirma" runat="server">
					<table class="griglia" id="Table2" width="100%" align="center">
						...
						<tr>
							<td>
								<asp:Button id="btnFirma" runat="server" Visible="False" cssclass="btn" Text="Firma"></asp:Button></td>
						</tr>
					</table>
				</asp:panel></P>
			<P><INPUT id="hContenutoFileFirmato" type="hidden" value="-" name="hContenutoFileFirmato">
				<INPUT id="flagfirma" name="flagfirma" type="hidden" value="0"> <INPUT id="TxtTitolareNome" runat="server" name="TxtTitolareNome" type="hidden">
