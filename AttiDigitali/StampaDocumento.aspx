<%@ Page Language="vb" AutoEventWireup="false" Codebehind="StampaDocumento.aspx.vb" Inherits="AttiDigitali.StampaDocumento" %>
...
<html>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:Button ID="ButtonContinua"  runat="server" Visible="False" Text="Stampa"></asp:Button>
			<asp:HyperLink ID="linkContinua" Target="_blank" runat="server" Visible="False">Stampa</asp:HyperLink>
		</form>
	</body>
</html>
