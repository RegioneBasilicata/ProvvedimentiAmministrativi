...
Partial Public Class Arrivederci
    ...
    '''<summary>
    '''Controllo lblArrivederci.
    '''</summary>
    '''<remarks>
    '''Campo generato automaticamente.
    '''Per la modifica, spostare la dichiarazione di campo dal file di progettazione al file code-behind.
    '''</remarks>
    Protected WithEvents lblArrivederci As Global.System.Web.UI.WebControls.Label

    '''<summary>
    '''Controllo lnkAutenticazione.
    '''</summary>
    '''<remarks>
    '''Campo generato automaticamente.
    '''Per la modifica, spostare la dichiarazione di campo dal file di progettazione al file code-behind.
    '''</remarks>
    Protected WithEvents lnkAutenticazione As Global.System.Web.UI.WebControls.HyperLink
End Class
